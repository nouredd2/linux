...
enum
{
  ...
  LINUX_MIB_TCPREQQFULLDOCHALLENGES, /* TCPReqQFullDoChallenges */
  ...
  LINUX_MIB_TCPSYNCHALLENGEFAILED, /* TCPSYNChallengeFailed */
  LINUX_MIB_TCPSYNCHALLENGESENT,   /* TCPSYNChallengeSent */
  LINUX_MIB_TCPSYNCHALLENGERECVD,  /* TCPSYNChallengeRecvd */
