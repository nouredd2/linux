...
static const struct snmp_mib snmp4_net_list[] = {
  ...
  SNMP_MIB_ITEM("TCPReqQFullDoChallenges", LINUX_MIB_TCPREQQFULLDOCHALLENGES),
  ...
  SNMP_MIB_ITEM("TCPSYNChallengeFailed", LINUX_MIB_TCPSYNCHALLENGEFAILED),
  SNMP_MIB_ITEM("TCPSYNChallengeRecvd", LINUX_MIB_TCPSYNCHALLENGERECVD),
  SNMP_MIB_ITEM("TCPSYNChallengeSent", LINUX_MIB_TCPSYNCHALLENGESENT),
